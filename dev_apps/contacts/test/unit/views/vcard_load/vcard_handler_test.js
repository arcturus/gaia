...
requireApp('views/vcard_load/js/vcard_handler.js');
requireApp('test/unit/mock_vcard_reader.js');

suite('VCardHandler', function() {
  const VCARD_PATH = '/apps/test/unit/vcards/';
  const VCARD_FILE =
    '/apps/test/unit/vcards/vcard_21.vcf';
  const VCARD_FILE_MULTIPLE =
    '/apps/test/unit/vcards/vcard_21_multiple.vcf';
  var realVCardReader;
  var fakeActivity = {
    source: {
      data: {
  ...
  setup(function() {
    loadBodyHTML('/views/vcard_load/vcard_load.html');
