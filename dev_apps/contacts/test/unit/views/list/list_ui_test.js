...
requireApp('test/unit/mock_contacts_shortcuts.js');
requireApp('test/unit/mock_cache.js');
requireApp('test/unit/mock_contacts_search.js');
requireApp('test/unit/mock_activities.js');
requireApp('test/unit/mock_contacts_list.js');
require('/shared/js/l10n.js');

require('/shared/test/unit/mocks/mock_contact_all_fields.js');
requireApp('views/list/js/list_ui.js');
requireApp('views/list/js/select_mode.js');
requireApp('views/list/js/list_utils.js');
...
suite('ListUI', function() {
  ...
  suiteSetup(function(done) {
    ...
    // Load HTML
    loadBodyHTML('/views/list/list.html');
    requireApp('js/header_ui.js', function() {
      done();
    });
  });
