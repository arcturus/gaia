...
requireApp('js/contacts_tag.js');
requireApp('js/views/form.js');
...
requireApp('test/unit/mock_external_services.js');
requireApp('test/unit/mock_fb.js');
requireApp('test/unit/mock_contacts_search.js');
requireApp('test/unit/mock_confirm_dialog.js');
requireApp('test/unit/mock_image_thumbnail.js');
