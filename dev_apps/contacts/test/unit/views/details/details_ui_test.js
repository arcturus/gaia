...
requireApp('js/activities.js');

require('/shared/test/unit/mocks/mock_contact_all_fields.js');
requireApp(
  'test/unit/webrtc-client/mock_webrtc_client.js');

requireApp('views/details/js/details_ui.js');
