...
requireApp('test/unit/mock_details_dom.js.html');
requireApp(
  'test/unit/webrtc-client/mock_webrtc_client.js');
...
requireApp('js/views/details.js');
requireApp('test/unit/mock_contacts_nfc.js');
...
requireApp('test/unit/mock_extfb.js');
requireApp('test/unit/mock_activities.js');
requireApp('test/unit/helper.js');
requireApp('js/utilities/mozContact.js');
requireApp('js/utilities/extract_params.js');
...
requireApp('js/tag_optionsstem.js');
