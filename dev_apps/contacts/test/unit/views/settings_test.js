...
requireApp('test/unit/mock_import_status_data.js');
requireApp('test/unit/mock_asyncstorage.js');
requireApp('test/unit/mock_cookie.js');
requireApp('test/unit/mock_get_device_storage.js');
requireApp('test/unit/mock_sdcard.js');
requireApp('test/unit/mock_icc_helper.js');
...
requireApp('js/utilities/normalizer.js');
