...
requireApp('test/unit/import/mock_import.html.js');
requireApp('test/unit/mock_asyncstorage.js');
requireApp('test/unit/mock_search.js');
requireApp('test/unit/mock_oauthflow.js');
...
requireApp('test/unit/import/mock_connector.js');
requireApp(
        'test/unit/import/mock_imported_contacts.js');
