...
requireApp('test/unit/mock_contacts_index.html.js');
requireApp('test/unit/mock_service_extensions.js');
requireApp('test/unit/mock_navigation.js');
requireApp('test/unit/mock_contacts.js');
requireApp('test/unit/mock_asyncstorage.js');
requireApp('test/unit/mock_fb.js');
requireApp('test/unit/mock_wakelock.js');
requireApp('test/unit/mock_sdcard.js');
requireApp('test/unit/mock_l10n.js');
requireApp('test/unit/mock_vcard_parser.js');
requireApp('test/unit/mock_event_listeners.js');
requireApp('test/unit/mock_sim_importer.js');
requireApp(
  'test/unit/mock_advanced_telemetry_helper.js');
requireApp('test/unit/mock_overlay.js');
requireApp('test/unit/mock_loader.js');
requireApp('test/unit/mock_fb_loader.js');
requireApp('services/contacts.js');


requireApp('views/settings/js/settings_controller.js');
requireApp('views/settings/js/settings_ui.js');
requireApp('js/utilities/icc_handler.js');
requireApp('js/utilities/sim_dom_generator.js');
