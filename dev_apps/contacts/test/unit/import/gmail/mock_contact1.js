...
var MockGoogleEntry = (function MockGoogleEntry() {
  ...
  req.open('GET', '/test/unit/import/gmail/mock_contact1.xml', false);
  req.send(null);
...
var MockGoogleEntryNoName = (function MockGoogleEntryNoName() {
  var req = new XMLHttpRequest();
  req.open('GET', '/test/unit/import/gmail/mock_contact2.xml', false);
  req.send(null);
...
var MockGoogleEntryInvalidDate = (function MockGoogleEntryWoName() {
  var req = new XMLHttpRequest();
  req.open('GET', '/test/unit/import/gmail/mock_contact3.xml', false);
  req.send(null);
...
var MockGoogleEntryNoFirstName = (function MockGoogleEntryNoFirstName() {
  var req = new XMLHttpRequest();
  req.open('GET', '/test/unit/import/gmail/mock_contact4.xml', false);
  req.send(null);
