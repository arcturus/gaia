...
requireApp('test/unit/mock_contacts_match.js');
requireApp('test/unit/' +
...
requireApp('test/unit/import/mock_rest.js');
requireApp('test/unit/base64_photo.js');
...
function initializeVCFReader(filename, cb) {
  ...
  oReq.open(
    'get', '/apps/test/unit/vcards/' + filename, true);
  oReq.send();
