...
requireApp('test/unit/mock_datastore_migrator.js');
...
requireApp('test/unit/mock_activities.js');
requireApp('test/unit/mock_contacts_details.js');
requireApp('test/unit/mock_contacts_search.js');
...
suite('Contacts', function() {
  ...
  suiteSetup(function(done) {
    ...
    requireApp('js/utilities/performance_helper.js');
    requireApp('js/main_navigation.js');
    requireApp('js/header_ui.js');
    requireApp('js/contacts.js', done);
  });
